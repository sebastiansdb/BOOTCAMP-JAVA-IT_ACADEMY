...
public class FlowerShop {
    ...
    public void printFlowerStock(){
        if (stock.getFlowerStock().isEmpty()){
            System.out.println("There is not FLOWERS stocked");
        } else {
    ...
    public void printDecorationStock(){
        if (stock.getDecorationStock().isEmpty()){
            System.out.println("There is not DECORATION stocked");
        } else {
    ...
    public void printShopValue(){
        System.out.println("The actual value of the " + flowerShopName.toUpperCase() + " shop is " + Math.round(stock.getStockValue()*100.0)/100.0 + "€.");
    }
