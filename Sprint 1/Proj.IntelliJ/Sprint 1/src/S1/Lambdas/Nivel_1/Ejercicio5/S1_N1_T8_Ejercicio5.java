...
public class S1_N1_T8_Ejercicio5 {
    ...
    public static void main (String[] args){
       ...
       /**
        * La operacion de arriba tambien se podria hacer sin instanciar un objeto de la clase S1_N1_T8_Ejercicio5. Así:
        MiInterfaceFuncional referenciaAMetodo = S1_N1_T8_Ejercicio5::miMetodoImplementado;
        * (Sólo que habria que hacer STATIC al metodo "miMetodoImplementado()")
        */
