...
//        playerEntityTest.setPlayerId(1L);
    ...
    public void should_successfully_add_a_player(){
        ...
        PlayerEntityDTO dtoTest = playerServiceImpl.addNewPlayer(playerDtoTest);
        // then
        assertEquals(dtoTest.getPlayerName(),playerEntityTest.getPlayerName());
    ...
    public void should_successfully_add_an_anonymous_player(){
        ...
        PlayerEntityDTO dtoTest = playerServiceImpl.addNewPlayer(playerDtoTest);
        //then
        assertEquals(dtoTest.getPlayerName(),"ANONYMOUS");
        assertEquals(dtoTest.getRegisterDate(),playerEntityTest.getRegisterDate());
        verify(playerRepository, times(1)).save(any(PlayerEntity.class));
    }
    @Test
    ...
    public void should_throw_EmptyListException() {
        // mock calls
