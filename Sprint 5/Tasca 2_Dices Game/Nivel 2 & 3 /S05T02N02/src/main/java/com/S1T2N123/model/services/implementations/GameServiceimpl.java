...
//    @Transactional
//    public void deleteAllGamesOfOnePlayer(Long playerId){
//        // check que exista el jugador
//        PlayerEntity playerEntity = playerServiceImpl.getPlayerById(playerId);
//        if (!playerEntity.getGames().isEmpty()){
...
//    }
    ...
    public List<GameEntityDTO> getAllGamesOfOnePlayer(Long playerId){
        PlayerEntity playerEntityToShow = playerServiceImpl.getPlayerById(playerId);
