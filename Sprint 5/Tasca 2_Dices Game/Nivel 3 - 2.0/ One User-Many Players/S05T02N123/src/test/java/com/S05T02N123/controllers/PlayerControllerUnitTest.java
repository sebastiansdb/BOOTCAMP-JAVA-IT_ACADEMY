...
//        // el service retorna null sólo cuando no hay ningun jugador perdedor
//        given(playerService.getLoserPlayer()).willReturn(null);
//
//        mockMvc.perform(get(uri))
//                .andDo(print())
//                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
...
//                "no winners";
//
//        given(playerService.getWinnerPlayer()).willReturn(null);
//
//        mockMvc.perform(get(uri))
//                .andDo(print())
//                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
