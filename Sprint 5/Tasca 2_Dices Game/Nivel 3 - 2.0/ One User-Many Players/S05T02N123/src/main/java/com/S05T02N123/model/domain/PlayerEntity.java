...
public class PlayerEntity {
    ...
    mappedBy indica el nombre de la variable, en la clase GameEntity, que voy a utilizar para
    ...
    Usar mappedBy = "player" en "List<GameEntity> games" indica que la entidad GameEntity no es la dueña de la relación.
