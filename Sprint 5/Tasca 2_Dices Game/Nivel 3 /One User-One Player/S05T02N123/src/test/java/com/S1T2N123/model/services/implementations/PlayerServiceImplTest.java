...
//        playerEntityTest.setPlayerId(1L);
    ...
    @Test
    @DisplayName("PlayerServiceImplUnitTest - Shows the average number of won games by all players ")
    public void should_return_average_success_rate_of_all_players(){
        ...
        // mocks
        when (playerRepository.findAll()).thenReturn(List.of(playerEntityTest, playerEntityTest2));
        when(gameServiceImpl.checkIfRegisteredGames()).thenReturn(true); // / Mock para checkIfRegisteredGames
    ...
    public void should_return_the_loser_player(){
        ...
        when(gameServiceImpl.checkIfRegisteredGames()).thenReturn(true);
        // when
...
//        when(gameServiceImpl.checkIfRegisteredGames()).thenReturn(false);
        // when
